...
export interface PresetUiGridItem extends NavLinkProps {
  path: string
  label?: ReactNode
}
export interface PresetUiGridRoutesProps extends GridProps {
  children: ReactNode
  basePath: string
  routes: PresetUiGridItem[]
  leftColProps?: GridColProps
  rightColProps?: GridColProps
}

export function PresetUiSidebarLayout({
  basePath,
  children,
  routes,
  leftColProps,

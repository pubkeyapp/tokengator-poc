...
export interface HomeUiGridItem extends NavLinkProps {
  path: string
  label?: ReactNode
}
export interface HomeUiGridRoutesProps extends GridProps {
  children: ReactNode
  basePath: string
  routes: HomeUiGridItem[]
  leftColProps?: GridColProps
  rightColProps?: GridColProps
}

export function HomeUiSidebarLayout({
  basePath,
  children,
  routes,
  leftColProps,
